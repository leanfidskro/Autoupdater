    ...
    internal partial class DownloadUpdateDialog : Form
    {
        ...
        private void WebClientOnDownloadFileCompleted(object sender, AsyncCompletedEventArgs asyncCompletedEventArgs)
        {
            ...
            try
            {
                ...
                {
                    _lgr.Trace("Zip file detected - unpacking internal resource ZipExtractor.exe");
                    string installerPath = Path.Combine(Path.GetDirectoryName(tempPath), "ZipExtractor.exe");

                    File.WriteAllBytes(installerPath, Resources.ZipExtractor);
                    _lgr.Trace("ZipExtractor.exe unpacked");
                    ...
                    _lgr.Info("Calling ZipExtractor with arguments " + arguments.ToString());
